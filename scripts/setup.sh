...
# Paso 5: Ejecutar Docker Compose para iniciar el agente de Portainer
echo "Paso 5: Iniciando el agente de Portainer con Docker Compose..."
docker-compose up -d
echo "El agente de Portainer se está ejecutando en segundo plano."